...
import static edu.ntnu.idatt2001.runarin.wargames.frontend.WarGamesApp.*;
...
import edu.ntnu.idatt2001.runarin.wargames.frontend.model.ArmyWrapper;
...
public class WarGamesController implements Initializable {
    ...
    public void btnStartBattle(ActionEvent actionEvent) {
        ...
        try {
            setBattle(new Battle(armyOneWrapper.getArmy(), armyTwoWrapper.getArmy()));
            getBattle().simulate(getTerrain());
    ...
    public void btnInitializeArmies(ActionEvent actionEvent) {
        ...
        initArmy(getFilePathArmyOne(), nameArmyOne, armyOneWrapper);
        initArmy(getFilePathArmyTwo(), nameArmyTwo, armyTwoWrapper);
    ...
    public void btnAddUnitsFromFileArmyOne(ActionEvent actionEvent) {
        ...
        try {
            armyOneWrapper.getArmy().addUnitsFromFile(getFilePathArmyOne());
            armyOneWrapper.updateViewContent();
        } catch (IOException e) {
    ...
    public void btnAddUnitsFromFileArmyTwo(ActionEvent actionEvent) {
        ...
        try {
            armyTwoWrapper.getArmy().addUnitsFromFile(getFilePathArmyTwo());
            armyTwoWrapper.updateViewContent();
        } catch (IOException e) {
    ...
    public void btnAddUnitsArmyOne(ActionEvent actionEvent) {
        setArmySelect(ArmySelect.ARMY_ONE);
    ...
    public void btnAddUnitsArmyTwo(ActionEvent actionEvent) {
        setArmySelect(ArmySelect.ARMY_TWO);
